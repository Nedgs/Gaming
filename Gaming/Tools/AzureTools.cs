...
namespace Gaming.Tools
{
    public class AzureTools
    {
        ...
        public AzureTools(string resourceName)
        {
            ...
            */
            ArmClient client = new ArmClient(new ClientSecretCredential("b7b023b8-7c32-4c02-92a6-c8cdaa1d189c",
                "60883abe-1cbc-4f6d-b01c-06eb3aa52649", "Pt68Q~WnQ7rIjDOFgoDUR5ATpyRQCQrqbH0O8cfX"));
        ...
        // Delete Ressource
        public async void DeleteRessource()
        {
            ResourceGroupResource resourceGroup = await GetResourceGroupAsync();
